...
(function () {
  const eye1Left = document.querySelector('.media__img--eye1Left');
  const eye1Right = document.querySelector('.media__img--eye1Right');
  const eye2Left = document.querySelector('.media__img--eye2Left');
  const eye2Right = document.querySelector('.media__img--eye2Right');
  const eye3Left = document.querySelector('.media__img--eye3Left');
  const eye3Right = document.querySelector('.media__img--eye3Right');
  const eyeLeftSocket = document.querySelector('.media__img--eye1SocketLeft');
  const eyeRightSocket = document.querySelector('.media__img--eye1SocketRight');
  const eyebrowLeft = document.querySelector('.media__img--eyebrowLeft');
  const eyebrowRight = document.querySelector('.media__img--eyebrowRight');
  const mouthSmile = document.querySelector('.media__img--mouthSmile');
  const mouthStrange = document.querySelector('.media__img--mouthStrange');
  const eyeLeftFix = document.querySelector('.media__img--eyeLeftFix');
  const eyeRightFix = document.querySelector('.media__img--eyeRightFix');
  ...
  function closeEye() {
    eye1Left.style.display = 'none';
    eye1Right.style.display = 'none';
    eye2Left.style.display = 'block';
    eye2Right.style.display = 'block';
    eye3Left.style.display = 'none';
    eye3Right.style.display = 'none';
    eyeLeftSocket.style.display = 'none';
    eyeRightSocket.style.display = 'none';
  }

  function openEye() {
    eye1Left.style.display = 'block';
    eye1Right.style.display = 'block';
    eye2Left.style.display = 'none';
    eye2Right.style.display = 'none';
    eye3Left.style.display = 'none';
    eye3Right.style.display = 'none';
    eyeLeftSocket.style.display = 'block';
    eyeRightSocket.style.display = 'block';
  ...
  function strangeEye() {
    ...
    eye2Left.style.display = 'none';
    eye2Right.style.display = 'none';
    eye3Left.style.display = 'block';
    eye3Right.style.display = 'block';
    eyeLeftSocket.style.display = 'none';
    eyeRightSocket.style.display = 'none';
  }
  ...
  function scheduleBlink() {
    const blinkInterval = 750 + Math.random() * 750; // 0.75-1.5 秒
    blinkTimer = setTimeout(() => {
      blinkOnce();
      scheduleBlink();
    }, blinkInterval);
  ...
  window.addEventListener('mousemove', (e) => {
    ...
    if (minDist < threshold && !inFocusZone) {
      ...
      stopBlinking();
      strangeEye();
      mouthStrange.style.display = 'block';
      mouthSmile.style.display = 'none';
    } else if (minDist >= threshold && inFocusZone) {
      inFocusZone = false;
      openEye();
      mouthStrange.style.display = 'none';
      mouthSmile.style.display = 'block';
      startBlinking();
    }

    // 抓兩隻眼睛的中心
    const rectL = eyeLeftFix.getBoundingClientRect();
    const rectR = eyeRightFix.getBoundingClientRect();
    const cL = {
      x: rectL.left + rectL.width / 2,
      y: rectL.top + rectL.height / 2,
    };
    ...
    eye1Left.style.transform = transformEye;
    eye1Right.style.transform = transformEye;
