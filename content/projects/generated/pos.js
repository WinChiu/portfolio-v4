const project = {
  ...
  "head": {
    "en": {
      "htmlLang": "en",
      "title": "POS TW/HK Payment Gateway Integration - Forward and Reverse Process Design",
  ...
  "introduction": {
    "en": {
      "purpose": "Designed the forward and reverse payment integration flow for SHOPLINE POS in Taiwan and Hong Kong, enabling merchants to complete transactions quickly while efficiently resolving errors to minimize customer wait times.",
      "challenge": "The POS product is already in use, and merchants are accustomed to the existing processes. To reduce learning costs, the design must align closely with the current workflow.",
      "production": "Completed the design of 6 forward and reverse payment system processes, covering 3 payment gateways, non-payment methods, and various payment outcome handling (success, failure, offline, operational errors, etc.).",
      "outcome": "Launched the product for use by merchants in Taiwan and Hong Kong."
    },
    "zh": {
      "purpose": "為 SHOPLINE POS 台灣與香港版金流串接需求，設計金流正逆流程的設計稿。讓店家能快速完成金流結帳流程，並有效協助排除錯誤狀態以避免顧客長時間的等待。",
      "challenge": "POS 產品已經上線使用且店家已習慣既有流程，為降低學習成本，在進行設計時需貼合既有流程進行。",
      "production": "完成 6 項正逆金流系統操作流程設計，涵蓋 3 種金流、非金流付款方式與多種付款結果處理（成功、失敗、離線、操作錯誤…）。",
        ...
        "modules": [
          {
            ...
            "content": "Based on the business situation outlined in the PRD, ==I defined\n                                                                                                      the product and design goals== for this project to focus on design\n                                                                                                      solutions."
          }
        ]
      },
      {
            ...
            "items": [
              {
                ...
                "title": "Business Goal: Increase Transaction Fee Revenue",
                "content": "Increase the number of orders using SHOPLINE Payment to boost\n                                                                                                          credit card transaction fee income."
              },
              {
                "image": {
                ...
                "title": "Product Goal: Provide Comprehensive Payment Services",
                "content": "Deliver a full suite of SHOPLINE Payment services (checkout,\n                                                                                                          cancellation, refund, returns) to enable merchants to offer\n                                                                                                          credit card payment options to consumers."
              },
              {
                "image": {
                ...
                "title": "Design Goal: Provide Seamless Payment Experience",
                "content": "Ensure that merchants can quickly complete the payment process\n                                                                                                          while effectively resolving errors to prevent prolonged\n                                                                                                          customer wait times."
              }
            ]
          }
        ]
        ...
        "modules": [
          {
            "type": "bigQuote",
            "icon": "../../img/sketch-think.svg",
            "content": "Although the PRD provided clear design solutions, ==I redefined\n                                                                                                      the problem and proposed a solution that better aligned with the\n                                                                                                      goals==, which was subsequently adopted."
          }
        ]
      },
      {
            ...
            "items": [
              {
                "type": "paragraph",
                "className": "project-module__text",
                "html": "It was initially expected that merchants would use the \"Summary\"\n                                                                                                      page in the POS system to review transactions and perform\n                                                                                                      settlement. Therefore, the original requirement aimed to prompt\n                                                                                                      the settlement operation on the \"Summary\" tab, but I found that\n                                                                                                      this did not align with user habits, so I made modifications."
              }
            ]
          },
          {
            "type": "singleImage",
            "image": {
              "src": "../../img/projects/pos/image-pos-sol1Origin-en.webp",
              "alt": "",
              "zoom": true
            }
          }
            ...
            "items": [
              {
                "type": "paragraph",
                "className": "project-module__text",
                "html": "SHOPLINE 是一個整合線上線下銷售的電商平台，提供 POS\n                                                                                                      系統幫助店家管理實體店面的支付流程。"
              },
              {
                "type": "paragraph",
                "className": "project-module__text",
                "html": "在本專案進行時，SHOPLINE 的 POS\n                                                                                                      系統在台灣尚未串接自有金流，店家需自行與銀行簽約；香港市場雖完成金流串接，但需支援多品牌刷卡機，且手續費高於市場平均。"
              }
            ]
          }
        ]
            ...
            "items": [
              {
                ...
                "title": "商業目標：提高手續費收益",
                "content": "增加使用 SHOPLINE Payment 的訂單以提升刷卡手續費收入。"
              },
              {
                "image": {
                  "src": "../../img/sketch-function.svg",
                ...
                "title": "產品目標：提供完整金流服務",
                "content": "提供完整（結帳、取消、退款、退貨）的 SHOPLINE Payment\n                                                                                                          金流服務，以支援店家提供消費者信用卡結帳的選項。"
              },
              {
                "image": {
                  "src": "../../img/sketch-webDesign.svg",
                ...
                "title": "設計目標：提供完整金流服務",
                "content": "讓店家能快速完成金流結帳流程，並有效協助排除錯誤狀態以避免顧客長時間的等待。"
              }
            ]
          }
        ]
            ...
            "items": [
              {
                "type": "paragraph",
                "className": "project-module__text",
                "html": "針對 POS 系統現有機制，盤點各狀態的判斷時機、回應時間與各金流 /\n                                                                                                      非金流的判斷差異。"
              }
            ]
          },
          {
