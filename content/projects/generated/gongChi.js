const project = {
  ...
  "head": {
    "en": {
      ...
      "imageAlt": "GongChi - Beiguan Music Mixer Simulation Website"
    },
    "zh": {
      "htmlLang": "zh",
  ...
  "introduction": {
    "en": {
      "purpose": "Provide step-by-step tutorials explaining the purpose of each button, along with a free-play mode to simulate the operation of the physical Beiguan music mixer 'Gong-Chi'.",
      "challenge": "",
      "production": "Use website animations and the Tone.js library to enable users to perform mixer operations such as pitch shifting, recording, mixing, and playing on a tablet with multi-touch functionality.",
      "outcome": ""
    },
    "zh": {
      "purpose": "以步驟式教學說明各按鍵用途，搭配自由遊玩模式，模擬實體北管樂混音器「工尺」的操作效果。",
      "challenge": "",
      "production": "以網站動畫與 tone.js 套件，讓使用者在平板上以多點觸控達到升降調、錄音、混音、演奏…等混音器操作效果。",
      "outcome": ""
    }
  },
  "sections": {
